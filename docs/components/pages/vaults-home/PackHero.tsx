  ...
  return (
    <>
      ...
      >
        ...
        >
        <HeroText h1>Gaur Vaults</HeroText>
          <HeroText h1>The best place to grow your assets</HeroText>
          <SectionSubtext hero>
           Gaur vaults automated strategies will alsoways find the best yeald for your assets. Always keep them working!
          </SectionSubtext>
        </FadeIn>
        <FadeIn
          delay={0.3}
        ...
        >
          <div className="flex flex-col w-full gap-3 md:!flex-row">
            <CTAButton>
              <Link href="/vaults/docs" className="block py-3">
                How to Stake?
              </Link>
            </CTAButton>
